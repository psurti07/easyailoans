...
@section('title','Welcome to EasyAILoans! ')
@push('style-css')
@endpush
            ...
            <div class="col-md-12 col-lg-12 col-xl-12 col-xxl-12">
                <div class="row g-5 mb-xl-0">
                    ...
                    <div class="notice d-flex bg-light-warning rounded border-warning border border-dashed  p-6">
                        <i class="ki-duotone ki-message-text fs-2tx text-warning me-4"><span class="path1"></span><span
                                class="path2"></span><span class="path3"></span></i>
                        <div class="d-flex flex-stack flex-grow-1 ">
                            <div class=" fw-semibold">
                                <h4 class="text-gray-900 fw-bold">Service Update</h4>
                                <div class="fs-6 text-gray-700 ">Dear Customer, a new update on your service has been
                                    added. <a class="fw-bold"
                                        href="{{ route('customer.loan.details',['loanAppId'=>encrypt($appId)]) }}">Check
                                        Here</a>.</div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-12 col-lg-12 col-xl-12 col-xxl-12">
                        <div
                            class="alert alert-dismissible bg-light-success border border-success d-flex flex-column flex-sm-row p-5">
                            <i class="ki-duotone ki-information-5 fs-2hx text-success me-4 mb-5 mb-sm-0"><span
                        ...
                        <div
                            ...
                            <div class="d-flex flex-column pe-0 pe-sm-10">
                                ...
                                <span class="fs-7 text-danger">
                                    {{ $message }}
                                    <a href="{{ route('customer.renew.plan') }}" class="me-2"
                                        id="kt_user_follow_button">
                                        <span class="indicator-label"><u>Renew Plan</u></span>
                                    </a>
                                </span>
                                @if($profile->acc_type == 1)
                                <span class="fs-7 mt-2 text-danger">Want to Hire Loan Agent for expert
                                    consultation?<br />
                                    <a href="{{ route('customer.renew.plan') }}" class="btn btn-sm btn-danger mt-2"
                                        id="kt_user_follow_button">
                    ...
                    <div class="col-md-12 col-lg-12 col-xl-12 col-xxl-12">
                        <div
                            class="alert alert-dismissible bg-light-warning border border-warning d-flex flex-column flex-sm-row p-5">
                    ...
                    <div class="card-body p-8">
                        <div class="d-flex flex-wrap flex-sm-nowrap mb-3">
                            ...
                            <div class="flex-grow-1">
                                <div class="d-flex justify-content-between align-items-start flex-wrap mb-2">
                                    <div class="d-flex flex-column">
                                        <div class="d-flex align-items-center mb-2">
                                            <a href="javascript:;"
                                                class="text-gray-900 text-hover-success fs-2 fw-bold me-1">{{ $profile->first_name.' '.$profile->last_name }}</a>
                                            <a href="javascript:;"><i
                                                    class="ki-duotone ki-verify fs-1 text-success"><span
                                                        class="path1"></span><span class="path2"></span></i></a>
                                        </div>
                                        <div class="d-flex flex-wrap fw-semibold fs-6 mb-2 pe-2">
                                            <p
                                                class="d-flex align-items-center text-gray-700 text-hover-success me-5 mb-2">
                                                <i class="ki-duotone ki-phone fs-4 me-1"><span
                                ...
                                <div class="d-flex">
                                    @if($profile->acc_type == 1)
                                    <a href="javascript:;" class="btn btn-sm btn-success me-2" data-bs-toggle="modal"
                                        data-bs-target="#kt_modal_upgrade_plan" data-bs-toggle="modal"
                                        data-bs-target="#kt_modal_upgrade_plan">
                                        <i class="ki-duotone ki-star fs-3"><span class="path1"></span><span
                                                class="path2"></span></i><span class="indicator-label"></span>Upgrade to
                                        Pro</span>
                                    </a>
                                    @endif

                                    <a href="{{ route('customer.profile') }}" class="btn btn-sm btn-light-info me-2"
                                        id="kt_user_follow_button">
                                        <i class="ki-duotone ki-pencil fs-3"><span class="path1"></span><span
                                                class="path2"></span></i><span class="indicator-label">Edit
                                            Profile</span>
                                    </a>
                                </div>
                            </div>
                        ...
                        <div class="card mb-xl-12">
                            <div class="card-header p-0">
                                <h3 class="card-title align-items-start flex-column">
                                    ...
                                    <span class="text-muted mt-1 fw-semibold fs-7">View your service timeline to stay
                                        updated, always!</span>
                                </h3>
                            </div>
                            <div class="card-body p-0">
                                <a href="{{ route('customer.download.report') }}" class="btn btn-sm btn-primary me-2"
                                    id="kt_user_follow_button">
                                    <i class="ki-duotone ki-file fs-3"><span class="path1"></span><span
                                            class="path2"></span></i>
        ...
        <div class="row mb-10">
            <div class="col-md-6 col-sm-12 col-lg-6 col-xl-6 col-xxl-6">
                ...
                <div class="card" data-bs-theme="light"
                    style="background: linear-gradient(112.14deg, #3ca46c 0%, #4fcd89 100%)">
                    <div class="card-body">
                        <div class="row align-items-center h-100">
                            <div class="col-12">
                                <div class="text-white mb-6 pt-6">
                                    <span class="fs-4 fw-semibold me-2 d-block lh-1 pb-2 opacity-75">Your Loan
                                ...
                                <div class="card mb-xl-6">
                                    <div class="card-body pt-9 pb-2">
                                        <div class="d-flex flex-wrap flex-sm-nowrap mb-3">
                                            <div class="me-7 mb-4">
                                                <div
                                                    class="symbol symbol-80px symbol-lg-80px symbol-fixed position-relative">
                                                    <img src="{{ asset('customer/assets/media/avatars/300-1.png') }}"
                                                        alt="image" />
                                                    <div
                                                        class="position-absolute translate-middle bottom-0 start-100 mb-6 bg-success rounded-circle border border-4 border-body h-20px w-20px">
                                                    </div>
                                            ...
                                            <div class="flex-grow-1">
                                                <div
                                                    ...
                                                    <div class="d-flex flex-column">
                                                        <div class="d-flex align-items-center mb-2">
                                                            <a href="javascript:;"
                                                                class="text-gray-900 text-hover-success fs-2 fw-bold me-1">{{ isset($agent->fullname) ? $agent->fullname : 'EasyAILoans Support' }}</a>
                                                            <a href="javascript:;"><i
                                                        ...
                                                        <div class="d-flex flex-wrap fw-semibold fs-6 mb-4 pe-2">
                                                            ...
                                                            <a href="javascript:;"
                                                                class="d-flex align-items-center text-gray-700 text-hover-success mb-2">
                ...
                @else
                <div class="card mb-10" data-bs-theme="light"
                    style="background: linear-gradient(112.14deg, #0e5281 0%, #198b8c 100%)">
                    <div class="card-body">
                        <div class="row align-items-center h-100">
                            <div class="col-12">
                                <img src="{{ asset('front/images/support.png') }}" width="60" height="60" alt="support">
                                <div class="text-white mb-2 pt-6">
                                    <span class="fs-4 fw-semibold me-2 d-block lh-1 pb-2 opacity-75"><u>Want Expert
                                            Consultation?</u></span>
                                    <span class="fs-2qx fw-bold">Process Your Pre-Approved Offers Instantly with Our
                                        Experts.</span>
                                </div>
                                <div class="d-flex flex-column flex-sm-row mt-4 d-grid gap-2">
                                    <a href="{{ route('customer.renew.plan') }}"
                                        class="btn btn-dark flex-shrink-0 me-lg-2">Hire Agent Now</a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="card border mb-10" data-bs-theme="light">
                    <div class="card-body">
                        <div class="align-items-center">
                            <div style="color:#1ebc62 !important">
                            ...
                            <div class="d-flex flex-column flex-sm-row d-grid gap-2">
                                <a href="{{ route('customer.download.report') }}"
                                    class="btn btn-success flex-shrink-0 me-lg-2"><i
                                        class="ki-duotone ki-file fs-2"><span class="path1"></span><span
                                            class="path2"></span></i>Download Report</a>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="row">
            <div class="col-md-12 col-lg-12 col-xl-12 col-xxl-12">
                <h6 class="text-danger">
                    <marquee scrollamount="8" behavior="scroll">BE AWARE! We ask our customers to make payments ONLY on
                        our website https://EasyAILoans.com and NOT through any other source, directly or indirectly.
                        Thanks!</marquee>
                </h6>
            </div>
        </div>
