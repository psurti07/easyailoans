...
<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
    <div class="container-xxl " id="kt_content_container">
        <div class="row g-8 mb-10">
            ...
            <div class="col-md-6 col-lg-6 col-xxl-4 mb-10">
                @if($isExpired)
                <div class="offer-card locked">
                    ...
                    <div class="card {{ $isExpired ? 'card-content' : '' }} h-md-100">
                        <div class="card-header d-flex justify-content-center align-items-center border-0"
                            style="{{ $loop->index != 0 ? 'background: rgba(0, 0, 0, 0) linear-gradient(120deg, #f94, #D9455A) 0 0 no-repeat;' : 'background: rgba(0, 0, 0, 0) linear-gradient(120deg, #198b8c, #0e5281) 0 0 no-repeat;' }}min-height:20px!important">
                            <h3 class="card-title">
                                <span
                        ...
                        <div class="card-body pt-7 px-0">
                            <div class="px-5">
                                <img src="{{ 'https://manage.easyailoans.com/upload/banks/'.$offer->bank_image }}"
