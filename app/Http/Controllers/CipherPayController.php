...
-----END PUBLIC KEY-----';       //header key
    ...
    public function StatusEnquiry(Request $request)
    {
        ...
        $actualReturnUrl = $secondLastSegment === 'self-apply' ? 'https://kredittap.com/self-apply/premium-offer-response' : 'https://Kredittap.com/loan-agent/ultra-saver-offer-response';

        $redirectUrl = $paymentMessage === 'Transaction Successfull' ? $actualReturnUrl : 'https://kredittap.com/cipher-payment-failed/';
