                                                    ...
                                                    <tr>
                                                        <td align="left"
                                                            ...
                                                            <table cellpadding="0" cellspacing="0" class="es-left"
                                                                align="left"
                                                                style="mso-table-lspace: 0;mso-table-rspace: 0;border-collapse: collapse;border-spacing: 0;float: left;background-color: #edf7f9;border: 1px solid #edf7f9;  border-radius: 12px; display: block;">
                                                                <tbody>
                                                                    <tr>
                                                                        <td class="es-m-p20b" align="left"
                                                                            ...
                                                                            <table cellpadding="0" cellspacing="0"
                                                                                ...
                                                                                style="mso-table-lspace: 0;mso-table-rspace: 0;border-collapse: separate;border-spacing: 0; border-radius: 15px;/* border: 1px solid #edf7f9; */ background-color: transparent;"
                                                                                role="presentation">
                                                                                <tbody>
                                                                                    <tr>
                                                                                        <td
                                                                                            style="padding:0  20px; margin: 0; line-height: 1.5rem;background-color: #edf7f9; color:#000;font-size:16px; border-radius: 12px;font-family: Poppins, sans-serif;">
                                                                    ...
                                                                    <tr>
                                                                        <td class="es-m-p20b" align="left"
                                                                            ...
                                                                            <table width="100%" bgcolor="#ffffff" style="border-radius: 15px; background-color: transparent;margin-bottom:15px;">
                                                                                <tr>
                                                                                    <td style="padding: 0 20px; background-color: #edf7f9; color: #000; font-size: 16px; border-radius: 12px;font-family: Poppins, sans-serif;">
