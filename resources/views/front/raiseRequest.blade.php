            ...
            <div class="row d-flex justify-content-center align-items-center">
                <div class="col-md-12 text-center">
                    <div class="txt-block left-column">
                        ...
                        <p class="s-16 w-400 mt-0">
                            Have a query? Raise a request with EasyAILoans and get quick assistance for all your loan
                            needs.
                        </p>
                    </div>
                </div>
        ...
        <div class="row justify-content-center">
            <div class="col-md-12 col-lg-6 col-12 align-items-center justify-content-center m-auto mt-0">
                <div id="contacts" class="contacts-section division">
                    <div class="card">
                        <div class="card-body">
                            <form method="post" action="{{ route('front.request.raised.post') }}"
                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group form-floating s-15">
                                            <input id="firstname" type="text" name="firstname" class="form-control s-15"
                                                placeholder="" />
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group form-floating s-15">
                                            <input id="lastname" type="text" name="lastname" class="form-control s-15"
                                                placeholder="" />
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group form-floating s-15">
                                            <input id="mobile" type="text" name="mobile" class="form-control s-15"
                                                placeholder="" minlength="10" maxlength="10" inputmode="numeric">
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group form-floating s-15">
                                            <input id="email" type="email" name="email" class="form-control s-15"
                                                placeholder="" />
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group form-floating s-15">
                                            <select id="issuetype" name="issuetype" class="form-select s-15">
                                                ...
                                                <option value="Eligibility or Pre-approval Query">Eligibility or
                                                    Pre-approval Query</option>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group form-floating s-15">
                                            <textarea id="message" name="message" style="height:150px"
                                                class="form-control s-15" placeholder=""></textarea>
                                    ...
                                    <div class="col-lg-12 form-btn text-right">
                                        <button type="submit"
                                            class="apply-btn s-15 btn-sm btn btn--theme hover--theme submit">Submit
                                            Request</button>
                                    </div>
                                </div>
                            </form>
            ...
            <div class="col-md-12 col-lg-6 col-12 mt-lg-0 mt-35">
                <div class="faqs-section">
                    <div class="faqs-3-questions">
                        <h2 class="s-28 mb-20 text-center">Frequently Asked Questions</h2>
