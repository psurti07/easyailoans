                                    ...
                                    <div class="card-body">
                                        ...
                                        <form action="{{ route('self.apply.buyNow') }}" id="unlockOffersForm" class="contact-form save-form-5" novalidate="novalidate" method="post" accept-charset="utf-8">
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-6 col-md-6 col-12">
                                                        ...
                                                        <div id="fb-12-3" class="fbox-12 bg--white-100 block-shadow r-12 mb-20">
                                                            ...
                                                            <div class="fbox-ico">
                                                                <div class="shape-ico">
                                                                    <img class="p-0" src="https://manage.easyailoans.com/upload/banks/{{ $offersData[0]['bank_image'] }}" alt="bank" width="160">
                                                                </div>
                                                            </div>	<!-- End Icon -->
                                                    ...
                                                    @foreach($offersData as $index => $item)
                                                        ...
                                                        <div class="col-lg-6 col-md-6 col-12">
                                                            ...
                                                            <div id="fb-12-3" class="fbox-12 bg--white-100 block-shadow r-12 mb-20 lockoffers">
                                                                ...
                                                                <div class="fbox-ico">
                                                                    <div class="shape-ico">
                                                                        <img class="p-0" src="https://manage.easyailoans.com/upload/banks/{{ $item['bank_image'] }}" alt="bank" width="160">
                                                                    </div>
                                                                </div>	<!-- End Icon -->
                                            ...
                                            <div class="col-md-12 form-btn mt-4">
                                                <button type="submit" class="btn btn--theme hover--theme submit unlockBtn w-100">Unlock Your Offers!</button>
                                            </div>
                                        </form>
                                    </div>
                                </div>
