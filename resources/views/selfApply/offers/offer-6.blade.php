            ...
            <div class="col-md-12 col-lg-6 self-apply-form order-1 order-md-1 order-lg-2 mb-lg-0 mb-25">
                <div id="hero-8-form" class="r-06">
                    ...
                    <p class="p-sm mt-3 mb-0 text-start">By submitting the form & proceeding, you agree to the <a
                            ...
                            class="text-dark text-decoration-none"> Privacy Policy</a> of EasyAILoans.</p>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row justify-content-center">
                <div class="col-md-12 col-lg-12">
                    <div class="section-title mb-40">
                        <h2 class="s-28 mb-5">Going Strong With <span class="color--green-500">Stronger
                ...
                <div class="form-holder">
                    <div class="contact-form-notice">
                        ...
                        <p class="s-14">
                            ...
                            website https://easyailoans.com and NOT through any other source, directly or indirectly.
                            Thanks!
                        </p>
                    </div>
                </div>
