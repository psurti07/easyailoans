                ...
                <div class="row d-flex align-items-bottom">
                    <div class="col-md-5 order-2 order-md-2">
                        <div class="hero-7-img home-img d-flex justify-content-center align-items-start">
                            <img src="{{ asset('front/images/offer/offer-img.webp') }}" alt="EasyAILoans" class="img-fluid">
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-6 self-apply-form  form-container order-1 order-md-1">
                        <div id="hero-8-form" class="r-06 bg-white p-4">
                            ...
                            <p class="p-sm mt-3 mb-0 text-start">By submitting the form & proceeding, you agree to the <a href="{{ route('front.terms.conditions') }}" target="_blank" class="text-dark text-decoration-none">Terms</a>  and <a href="{{ route('front.privacy.policy') }}" target="_blank" class="text-dark text-decoration-none"> Privacy Policy</a> of EasyAILoans.</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row justify-content-center">
                    <div class="col-md-12 col-lg-12">
                        <div class="section-title mb-40">
                            <h2 class="s-28 mb-5">Going Strong With <span class="color--green-500">Stronger Recommendations!</span></h2>
            ...
            <div class="row justify-content-center">
                <div class="col-md-12 col-lg-12">
                    <div class="section-title text-center mb-40">
                        <h2 class="s-28 mb-5">Our <span class="color--green-500">Happy Customer</span></h2>
